...
//USO DE FETCH POR PRIMERA VES Y VEMOS COMO SE VE ESTO EN LA CONSOLA

// Ya sabemos que recibimos un formato de datos que se parece a un objeto pero no lo es que es el JSON!
// Vamos a limpiar ese json para pasarlo a un objeto manipulable dentro de js
// Esto ^ es posible a traves de el metodo nativo json()
fetch("https://jsonplaceholder.typicode.com/posts")
  .then((informacionDeRecursoUrl) => informacionDeRecursoUrl.json())
  .then((recursoDeWebTipoJsonConMetodoJsonNativo) =>
    console.log(recursoDeWebTipoJsonConMetodoJsonNativo)
  );
...
// la direccion no fue encontrada
...
// KEYWORDs
// peticion, servidor, direccion, protocolos

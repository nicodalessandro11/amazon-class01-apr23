...
// SIMPLE EXAMPLE OF A FUNCTION DOING A MATEHMATICAL ALGORITHIM
function gemma() {
  //   alert("Hello Gemma");
  return 2 + 2;
}
...
//console.log(miCoolFunc());

// SYNTAX de Funcion Simple
//function miFunction() {}
...
//console.table(["Argentina", "España", "Francia"]);

let countries = ["Argentina", "España", "Francia"];
console.table(countries[0]);

console.log(["Barcelona", "Berlin", "Tokyo", "Malaga"]);
// console.table(["Barcelona", "Berlin", "Tokyo", "Malaga"]);
